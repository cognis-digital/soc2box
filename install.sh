#!/usr/bin/env sh
# Universal installer for soc2box. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/soc2box.git"
echo "Installing soc2box ..."
