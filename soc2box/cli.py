...
import argparse, sys
from soc2box.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="soc2box", description="SOC2BOX — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from soc2box.mcp_server import serve
        return serve()
    if args.cmd == "scan":
