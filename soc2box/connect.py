"""Native cognis-connect emit for soc2box — forward findings to any platform.

Maps soc2box's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    soc2box ... --format json | soc2box-emit --to stix
    soc2box-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
