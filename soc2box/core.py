"""SOC2BOX core — SOC 2 evidence collector and control tracker, self-hosted."""
...
RULES = [
    ("SOC-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SOC-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SOC-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
