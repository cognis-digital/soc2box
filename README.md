...
> Cognis Open Collaboration License (COCL) v1.0 · domain: `compliance`

[![PyPI](https://img.shields.io/pypi/v/cognis-soc2box.svg)](https://pypi.org/project/cognis-soc2box/)
[![CI](https://github.com/cognis-digital/soc2box/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/soc2box/actions)
...
SOC2BOX exists for one job — soc 2 evidence collector and control tracker, self-hosted — and does it without a SaaS bill or heavyweight setup.
...
```bash
soc2box --version
soc2box scan .                      # scan the current project
soc2box scan . --format json
soc2box scan . --fail-on high       # non-zero exit for CI gates
soc2box mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Comp AI / Probo**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`soc2box` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
